# Trainer, predicter and evaluater for LayoutLMv3 fine-tuning with geometric position and text information of tokens
...
# For custom training without visual context
...
def prepare_dataset(cache_dir, split):
    ...
    def prepare(ex):
        ...
        enc = processor(
            images, ex['tokens'], boxes=ex['bboxes'],
