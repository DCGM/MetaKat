...
#DATASET
IMAGES_DIR_HOST=~/Desktop/actual_neighbors
TEXT_DIR_HOST=~/Desktop/bakalarka/data/page_descriptions_keywords
DATASET_BASE_DIR=~/Desktop
TRN_FILE=${DATASET_BASE_DIR}/trn.neighbors
TST_FILE=${DATASET_BASE_DIR}/tst.neighbors

DATALOADER_NUM_WORKERS=4

#MODEL
MODEL_NAME=openai/clip-vit-base-patch16
NET=clip-vit-base-patch16-full-desciptions_with_neighbors
