...
#DATASET
IMAGES_DIR_HOST=/mnt/matylda1/ikohut/data/smart_digiline/page_types/images_neighbour
DATASET_BASE_DIR=/mnt/matylda1/ikohut/data/smart_digiline/page_types/ann
NEIGHBOUR_PAGE_MAPPING=/mnt/matylda1/ikohut/data/smart_digiline/page_types/mappings/neighbour_page_mapping.current.all
POSITION_PATCH_SIZE=32
...
NET=vit-base-patch16-224-in21k
...
python -u ${DIGILINKA}/page_type_nets/train.py --project-name ${PROJECT_NAME} \
		   ...
		   --eval-pages ${TST_FILE} \
                   ...
                   --fp16 \
                   --neighbour-page-mapping ${NEIGHBOUR_PAGE_MAPPING} \
                   --position-patch-size ${POSITION_PATCH_SIZE} \
		   --eval-train-dataset \
